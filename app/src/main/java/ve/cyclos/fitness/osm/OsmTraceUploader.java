...
public class OsmTraceUploader {
    ...
    private void executeTask(){
        ...
        OsmConnection osm = new OsmConnection(
                "https://api.openstreetmap.org/api/0.6/", "CyclosApp", consumer);
        ...
        setProgress(25);
        new GpsTracesDao(osm).create(workout.getDateString(), visibility, description, Collections.singletonList("CyclosApp"), trackpoints);
        setProgress(100);
        handler.post(() -> {
